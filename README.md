...
- internal link suggestions**
  - generate embeddings of all published articles and find the closest matches for each new one. instead of guessing what to link to, the system tells you.
- image hosting
  - automatically compress and re-upload images to a permanent host (r2, s3, cloudinary, next.js) so you're not shipping google drive links to production.
- richer meta
  - extend beyond title/description/keywords to og image generation, json-ld schema (article, faq, how-to), and twitter card tags. most of this can be derived from what's already extracted.
- batch mode
